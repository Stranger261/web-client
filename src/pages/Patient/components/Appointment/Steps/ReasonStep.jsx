...
export const ReasonStep = ({
  ...
  // Appointment Type options based on your database enum
  const appointmentTypeOptions = [
    ...
    },
    {
      value: 'followup',
      label: 'Follow-up',
      description: 'Follow-up visit after previous appointment',
      icon: RefreshCw,
      color:
  ...
  // Simplified common reasons that can be used as suggestions
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Provide the details for this appointment
        </p>
      </div>
          ...
          {appointmentTypeOptions.map(type => {
            ...
            return (
              <button
                ...
                className={`relative flex items-start gap-4 p-4 border-2 rounded-xl transition-all text-left ${
      ...
      <div>
          ...
          <div className="flex flex-wrap gap-2">
            {commonReasonSuggestions.map(suggestion => (
              <button
                ...
                className={`px-3 py-1.5 text-sm border rounded-md transition-colors whitespace-nowrap ${
                  reason === suggestion
        ...
        <textarea
          ...
          placeholder={
            appointmentType === 'followup'
              ...
              ? 'Describe any specific concerns for this check-up...'
              : 'Describe the reason for this appointment in detail...'
          }
          rows={4}
        ...
        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
          Be specific to help the doctor prepare for the appointment. Include
          symptoms, duration, and any relevant details.
        </p>
      </div>
          ...
          <p>
            ...
            <span
              className={`ml-2 px-2 py-0.5 rounded text-xs font-medium ${
                appointmentTypeOptions.find(t => t.value === appointmentType)
                  ?.color
              }`}
            >
              {
