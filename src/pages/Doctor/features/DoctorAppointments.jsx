...
import DoctorAppointmentsTable from '../components/Appointment/DoctorAppointmentsTable';
...
const DoctorAppointment = () => {
  ...
  const [view, setView] = useState('table'); // Auto-detect view
          ...
          <div className="border-t bg-white px-4 sm:px-6 py-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleFilterChange}
                    className="w-full pl-10 pr-3 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                  />
                </div>
              </div>
            ...
            {activeFiltersCount > 0 && (
              <div className="mt-3 pt-3 border-t flex items-center gap-2 flex-wrap">
                ...
                {filters.appointment_type && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 text-green-700 rounded-md text-xs font-medium border border-green-200">
                    ...
                    <button
                      ...
                      className="hover:bg-green-100 rounded-sm p-0.5"
                    >
                      <X size={12} />
                    </button>
                  </span>
                ...
                {filters.consultation_method && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-purple-50 text-purple-700 rounded-md text-xs font-medium border border-purple-200">
                    Method: {filters.consultation_method}
                    <button
                      onClick={() =>
                        handleFilterChange({
                          target: { name: 'consultation_method', value: '' },
                        })
                      }
                      className="hover:bg-purple-100 rounded-sm p-0.5"
                    >
                      <X size={12} />
                    </button>
                  </span>
                ...
                {filters.priority && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-red-50 text-red-700 rounded-md text-xs font-medium border border-red-200">
                    ...
                    <button
                      ...
                      className="hover:bg-red-100 rounded-sm p-0.5"
                    >
                      <X size={12} />
                    </button>
                  </span>
                ...
                {filters.from_date && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-yellow-50 text-yellow-700 rounded-md text-xs font-medium border border-yellow-200">
                    ...
                    <button
                      ...
                      className="hover:bg-yellow-100 rounded-sm p-0.5"
                    >
                      <X size={12} />
                    </button>
                  </span>
                ...
                {filters.to_date && (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-pink-50 text-pink-700 rounded-md text-xs font-medium border border-pink-200">
                    To: {filters.to_date}
                    <button
                      onClick={() =>
                        handleFilterChange({
                      ...
                      className="hover:bg-pink-100 rounded-sm p-0.5"
                    >
                      <X size={12} />
                    </button>
                  </span>
